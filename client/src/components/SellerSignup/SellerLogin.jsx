...
import {validate } from '../UserSignup/validatelogininput'
...
export function SellerLogin() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/SellerLogin`, Sellerschema);
...
if (data) {
  ...
  return (
    <div className='flex justify-center mt-20'>
      <div className="px-2 bg-[#f1f1f1] font-serif font-[Georgia] rounded-xl md:rounded-l-xl md:rounded-r-none opacity-90 text-wrap max-w-96 pt-6 ">
        <h1 className="text-2xl font-semibold flex justify-center items-center m-3 underline mt-5">Artist Login</h1>
    ...
    >
      {passicon ? (
        ...
        <div className='ml-4 my-4'>Create a new account? <span className='underline text-blue hover:cursor-pointer' onClick={()=>{navigate("/SellerSignup")}}>Sign Up</span></div>
