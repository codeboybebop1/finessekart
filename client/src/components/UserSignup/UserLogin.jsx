...
import {validate } from './validatelogininput'
  ...
  return (
    <div className='flex justify-center mt-20'>
      <div className="px-2 bg-[#f1f1f1] font-serif font-[Georgia] rounded-xl md:rounded-l-xl md:rounded-r-none opacity-90 text-wrap max-w-96 ">
        <h1 className="text-2xl font-semibold flex justify-center items-center m-3 underline mt-5 ">User Login</h1>
    ...
    >
      {passicon ? (
        ...
        <div className='ml-4 my-4'>Create a new account? <span className='underline text-blue hover:cursor-pointer' onClick={()=>{navigate("/UserSignup")}}>Sign Up</span></div>
